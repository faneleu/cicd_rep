		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#nscicdbusinesspartnerscicd-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nscicdbusinesspartnerscicd-display": {
								"semanticObject": "nscicdbusinesspartnerscicd",
								"action": "display",
								"description": "A Fiori application cicd",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nscicd.businesspartnerscicd",
									"url": sap.ui.require.toUrl("nscicd/businesspartnerscicd")
								}
							}
						}
					}
